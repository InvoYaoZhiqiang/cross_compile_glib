...
#define GLIB_BINARY_AGE 4602

/* Define to the GLIB interface age */
#define GLIB_INTERFACE_AGE 2

/* Define the location where the catalogs will be installed */
#define GLIB_LOCALE_DIR "/opt/fslc-wayland/2.5.2/sysroots/aarch64-fslc-linux/usr/share/locale"
...
#define PACKAGE_STRING "glib 2.46.2"
